...
export default function HeroCarousel({ 
    ...
    try {
      ...
      if (activeSlides.length > 0) {
        ...
        setRegularSlides([{
          ...
          buttonText: 'Your Pretty Girl Matter Consultation Starts Here',
  ...
  return (
    <section id="hero" className="flex items-end relative overflow-hidden" style={{ height: '90vh', width: '100vw', marginTop: '0', marginLeft: 'calc(-50vw + 50%)', marginRight: 'calc(-50vw + 50%)', maxHeight: '90vh' }}>
      {/* Plaque Badge - Upper Right Corner */}
      <div className="absolute top-4 right-4 z-30">
        <img 
          src="/images/a-pretty-girl-matter-plaque.webp" 
          alt="A Pretty Girl Matter Plaque" 
            ...
            {currentSlide.styleType === 'google-review' ? (
              <div className="fade-in-1 flex flex-col items-center justify-center min-h-[50vh]">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-3 mt-8 fade-in-3">
                  ...
                  >
                    {currentSlide.buttonText || 'Your Pretty Girl Matter Consultation Starts Here'}
