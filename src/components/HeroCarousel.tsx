  ...
  return (
    <section id="hero" className="flex items-end relative overflow-hidden" style={{ height: '90vh', width: '100vw', marginTop: '0', marginLeft: 'calc(-50vw + 50%)', marginRight: 'calc(-50vw + 50%)', maxHeight: '90vh' }}>
      ...
      <div className="absolute top-4 left-0 right-0 z-30 flex justify-center">
        <a 
          href="https://www.google.com/maps/place/A+Pretty+Girl+Matter"
          target="_blank"
          rel="noopener noreferrer"
          className="bg-white/95 backdrop-blur-sm rounded-xl px-6 py-3 shadow-lg flex items-center gap-4 hover:bg-white transition-colors"
        >
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-xs text-gray-500">Read our reviews</p>
          </div>
        </a>
      </div>
